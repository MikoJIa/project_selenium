...
# команда time.sleep() устанавливает паузу в 5 сек. что бы мы успелить увидеть, что происходит в браузере
time.sleep(5)
...
# метод принимает в качестве аргументов способ поиска и значения, по которому мы будем искать.
